function myFunction () {
  alert("'Did you know that transistors are found in many electronics and they are used to transfer resistance? This means it is used as an amplifier or a switch by letting flow current in different intensities and channels?' BYJU'S (n.d.) Transistor Working [online] Available from: https://byjus.com/physics/transistor-working/ [Accessed 04 october 2022]");
}
